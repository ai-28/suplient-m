...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full border shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=checked]:bg-primary-foreground data-[state=checked]:border-primary/20 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-muted data-[state=unchecked]:border-border"
      )}
    />
  </SwitchPrimitives.Root>
))
