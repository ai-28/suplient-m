...
export async function GET(request, { params }) {
    try {
        ...
        // Fetch resources shared with this group
        ...
        const formattedResources = resources.map(resource => ({
            id: resource.id,
            name: resource.title,
            type: resource.resourceType?.toLowerCase() || 'file',
        ...
        return NextResponse.json({
            message: 'Group resources fetched successfully',
